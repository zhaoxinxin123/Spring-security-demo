...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath +"/one_security/src/main/java");
...
//        pc.setModuleName("one_security");//父包名
        pc.setParent("com.study.demo");// 自定义包路径  如果为空，将下面子包名必须写全部， 否则就只需写子包名
...
//        strategy.setRestControllerStyle(true);//生成 @RestController 控制器
        ...
        strategy.setInclude("t_user");//需要包含的表名，允许正则表达式
